            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-10">
              ...
              {step === 2 && (
                <div data-testid="step-datetime">
                  ...
                  <div className="border-2 border-gray-300 rounded-xl p-2 sm:p-4 md:p-6 mb-6 bg-white overflow-hidden">
                    <Calendar
                      mode="single"
                      ...
                      classNames={{
                        ...
                        nav_button: "h-7 w-7 sm:h-8 sm:w-8 bg-transparent p-0 opacity-50 hover:opacity-100 border border-gray-300 rounded-lg inline-flex items-center justify-center",
                        nav_button_previous: "absolute left-1",
                        nav_button_next: "absolute right-1",
                        table: "w-full border-collapse",
                        head_row: "flex w-full",
                        head_cell: "text-muted-foreground rounded-md flex-1 font-medium text-xs sm:text-sm text-center py-1 sm:py-2",
                        row: "flex w-full mt-0.5 sm:mt-1",
                        cell: "flex-1 text-center text-xs sm:text-sm p-0 sm:p-0.5 relative focus-within:relative focus-within:z-20",
                        day: "h-8 w-8 sm:h-10 sm:w-10 mx-auto p-0 font-normal rounded-lg hover:bg-gray-100 inline-flex items-center justify-center aria-selected:opacity-100 text-xs sm:text-sm",
