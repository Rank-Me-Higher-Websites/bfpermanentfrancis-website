            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sm:p-10">
              ...
              {step === 2 && (
                <div data-testid="step-stylist">
                  ...
                  <h2 className="font-heading text-2xl font-bold mb-1">Choose Your Stylist</h2>
              ...
              {step === 3 && (
                <div data-testid="step-datetime">
                  ...
                  <h2 className="font-heading text-2xl font-bold mb-1">Pick Date & Time</h2>
              ...
              {step === 4 && (
                <div data-testid="step-info">
                  ...
                  <h2 className="font-heading text-2xl font-bold mb-1">Your Information</h2>
              ...
              {step === 5 && (
                <div data-testid="step-review">
                  ...
                  <h2 className="font-heading text-2xl font-bold mb-1">Review Your Booking</h2>
