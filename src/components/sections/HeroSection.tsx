      ...
      <div className="section-container relative z-10 py-8 sm:py-24 w-full">
        <div className="flex flex-col lg:flex-row items-center lg:items-center gap-6 sm:gap-14 lg:gap-20">
          <div className="flex-1 text-center lg:text-left">
            ...
            <h1 className="mb-4 sm:mb-8 text-white text-3xl sm:text-5xl lg:text-[3.75rem] leading-[0.95]" style={{ letterSpacing: '-0.025em', fontFamily: "'Montserrat', system-ui, sans-serif", fontWeight: 900, fontStyle: 'italic', textShadow: '0 2px 30px rgba(0,0,0,0.3)' }}>
